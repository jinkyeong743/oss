...
### **프로젝트 개요**
캔버스에 그림을 그리면 선을 분석하여 멜로디를 생성하는 프로그램입니다. 사용자가 그린 선의 길이, 위치, 복잡도를 계산하고 여기에 사용자가 선택한 감정을 반영하여 멜로디를 생성합니다. 복잡한 선은 12음계, 단순한 선은 5음계를 사용하는 등 그림에 따라 음악적 특징이 달라지며, 선의 개수가 하나씩 추가될 때마다 화음의 수도 하나씩 추가되어 다중창 멜로디를 생성합니다.
